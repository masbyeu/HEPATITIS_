  ...
  default:
    if ($_POST['submit']) {
     ...
     <div class='alert alert-success alert-dismissible'>
                ...
                Silahkan memilih gejala sesuai dengan kondisi pasien, anda dapat memilih kepastian kondisi pasien dari pasti tidak sampai pasti ya, jika sudah tekan tombol proses (<i class='fa fa-search-plus'></i>)  di bawah untuk melihat hasil.
              </div>
