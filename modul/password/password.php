<title>Ubah Password - Checker</title>
        ...
        case "updatepassword":
            ...
            if ($data['password'] ==  md5($passwordlama)) {
                if ($passwordbaru1 == $passwordbaru2) {
                    ...
                    if ($hasil) {
                        echo "<h2><a href='#'></a></h1>Password berhasil diubah";
                    }
                } else {
                    echo "<h2><a href='#'></a></h1>Password baru Anda tidak sama";
                }
            } else {
                echo "<h2><a href='#'></a></h1>Password lama Anda salah";
            }
            break;
    }
} else {
