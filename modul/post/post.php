    ...
    switch ($_GET['act']) {
        ...
        default:
            ...
            echo "<form method=POST action='?module=post' name=text_form onsubmit='return Blank_TextField_Validator_Cari()'>
              ...
              <tr>
                  <td>
                      <input class='btn bg-olive margin' type=button name=tambah value='Tambah Post' onclick=\"window.location.href='post/tambahpost';\">
            ...
            if ($_POST['Go']) {
                    ...
                    while ($r = mysqli_fetch_array($hasil)) {
                        ...
                        echo "
                            <tr class='" . $warna . "'>
                                ...
                                <td>$r[srn_post]</td>
                                <td align=center>
                                    <a type='button' class='btn btn-success margin' href=post/editpost/$r[kode_post]>
                ...
                if ($baris > 0) {
                    ...
                    for ($i = 1; $i <= $halaman; $i++) {
                        $newoffset = $limit * ($i - 1);
                        if ($offset != $newoffset) {
                            echo "<a href=index.php?module=post&offset=$newoffset>$i</a>"; //cetak halaman
                        } else {
