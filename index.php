...
<html><head>
  ...
  <body id="pakarayam" class="hold-transition skin-red-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i>C</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>hecker Hepa</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Hepatitis </small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">IM HERE CHECK ME OUT  <i class="fa fa-heart pulse"></i> by <a href="https://github.com/masbyeu " target="_blank">masbyeu</a></div></strong>
      </footer>
